...
@Repository
public interface EncabezadoFacturaViewRepository extends JpaRepository<EncabezadoFacturaView, Integer> {
    List<EncabezadoFacturaView> findByEstadoNot(String estado);
    List<EncabezadoFacturaView> findByCedulaApoderado(Long cedula);
    List<EncabezadoFacturaView> findByIdFactura(Integer idFactura);
}
